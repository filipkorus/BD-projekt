...
$viewCarDetails = Join-Path $scriptRoot "views\dane_samochodow.sql"
$viewOpenAuctions = Join-Path $scriptRoot "views\otwarte_aukcje.sql"
$viewOngoingAuctions = Join-Path $scriptRoot "views\moje_aktualne_aukcje.sql"
$viewFinishedAuctions = Join-Path $scriptRoot "views\moja_historia_aukcji.sql"
...
Invoke-Expression "$psql $viewCarDetails"
Invoke-Expression "$psql $viewOpenAuctions"
Invoke-Expression "$psql $viewOngoingAuctions"
Invoke-Expression "$psql $viewFinishedAuctions"
