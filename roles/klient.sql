...
GRANT EXECUTE ON FUNCTION wyswietl_dane_samochodu TO klient_group;
...
GRANT SELECT, INSERT (tytul, wystawione_przez_uid, cena, sid, koniec_aukcji), UPDATE (sprzedane, kupione_przez_uid), DELETE ON aukcje TO klient_group;
